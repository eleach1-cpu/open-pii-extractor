...
| lib/strip-letter-pii.js | src/lib/pii/strip-letter-pii.js | ebd2ad5a + pending spaced-ICN fix (platform working tree 2026-08-29, not yet committed there) | none (verbatim) |
...
| test/pii-redaction.test.js | tests/pii-redaction.test.js | ebd2ad5a + spaced-ICN pin | requires repointed to lib/; every assertion kept, 64/64 pass |
